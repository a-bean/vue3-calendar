<template>
  <div style="height: 90vh; width: 100%">
    <Calendar
      v-slot="slotProps"
      :data="data"
      :calendar-view="ECalendarType.WEEK"
...
const lastTempDataKeys = dayjs(tempDataKeys).add(1, 'day').format('YYYY-MM-DD');
const lastLastTempDataKeys = dayjs(lastTempDataKeys).add(1, 'day').format('YYYY-MM-DD');
...
const getDateScope = (scope: [string, string]) => {
  ...
  data.value = {
    [tempDataKeys]: [
      ...
      { id: 13, title: '库里', start: `${tempDataKeys} 00:01`, end: `${lastTempDataKeys} 00:00`, color: '#8B5CF6' },
      ...
      // 来一个一整天的
      { id: 20, title: '麦迪', start: `${tempDataKeys} 00:00`, end: `${lastLastTempDataKeys} 00:00`, color: 'red' },
